...
function OrientationDetectorDevice() {
  ...
  return (
    <div className={`orientation_detector ${mobileHorizontal ? 'is_mobile_horizontal' : ''}`.trim()}>
      <figure className='container_figure'>
        <img className='rotate_icon' src={ rotateDeviceImage } />
        <div className='msg'>Gire o dispositivo para a posição vertical e veja o conteúdo desta página</div>
      </figure>
    </div>
  );
}
